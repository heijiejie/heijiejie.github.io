function Block(fallingLane, color, iter, distFromHex, settled) {
	...
	this.incrementOpacity = function() {
		if (this.deleted) {
			...
			if (this.opacity <= 1="" 0)="" {="" slate="" for="" final="" deletion="" this.opacity="0;" this.deleted="2;" if="" (gamestate="=" ||="" gamestate="=0)" localstorage.setitem("savestate",="" exportsavestate());="" }="" };="" this.getindex="function" (){="" get="" the="" index="" of="" block="" in="" its="" stack="" var="" parentarr="MainHex.blocks[this.attachedLane];" (var="" i="0;" <="" parentarr.length;="" i++)="" (parentarr[i]="=" this)="" return="" i;="" this.draw="function(attached," index)="" this.height="settings.blockHeight;" (math.abs(settings.scale="" -="" settings.prevscale)=""> 0.000000001) {
		...
		if (Math.abs(this.angle - this.targetAngle + this.angularVelocity) <= math.abs(this.angularvelocity))="" {="" do="" better="" soon="" this.angle="this.targetAngle;" this.angularvelocity="0;" }="" else="" +="this.angularVelocity;" this.width="2" *="" this.distfromhex="" math.sqrt(3);="" this.widthwide="2" (this.distfromhex="" this.height)="" this.height="" 3;="" var="" p1;="" p2;="" p3;="" p4;="" if="" (this.initializing)="" rat="((MainHex.ct" -="" this.ict)="" this.initlen);="" (rat=""> 1) {
				rat = 1;
			}
